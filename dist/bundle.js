...
/* harmony export */   AnimeFetcher: () => (/* binding */ AnimeFetcher)
/* harmony export */ });
...
/* harmony import */ var _Database_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Database.js */ "./Database.js");
...
class AnimeFetcher {
    constructor(url) {
        ...
        this.database = _Database_js__WEBPACK_IMPORTED_MODULE_1__.db; // 创建 Database 实例
    ...
    async fetchLatestEpisode() {
        try {
            ...
            const $ = (0,cheerio__WEBPACK_IMPORTED_MODULE_0__.load)(html); // 使用 load 方法加载 HTML
    ...
    addPropertiesToRecords(watchAnimeRecords, latestEpisodeInfo) {
        ...
        watchAnimeRecords.forEach(record => {
            ...
            Object.keys(latestEpisodeInfo).forEach(key => {
             ...
             // 更新数据库中的记录
        _Database_js__WEBPACK_IMPORTED_MODULE_1__.db.updateAnime(record); // 假设 db 是你的数据库实例
...
/* harmony export */ });
/* harmony import */ var _IndexedDBHelper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./IndexedDBHelper.js */ "./IndexedDBHelper.js");
 // 确保路径正确
...
class Database {
    ...
    constructor() {
        ...
        this.dbHelper = new _IndexedDBHelper_js__WEBPACK_IMPORTED_MODULE_0__["default"](Database.DB_NAME, 1);
...
/* harmony export */ });
/* harmony import */ var _Database_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Database.js */ "./Database.js");
...
class History {
    ...
    static async recordWatchHistory(title, url, episode) {
        ...
        return await _Database_js__WEBPACK_IMPORTED_MODULE_0__.db.addAnime(record); // 保存观看历史记录
    }
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexedDBHelper);
    ...
    async handleMessage(request, sendResponse) {
        ...
        switch (request.action) {
            case 'recordWatchHistory':
                ...
                try {
                    await _History_js__WEBPACK_IMPORTED_MODULE_1__.History.recordWatchHistory(request.title, request.url, request.episode); // 记录观看历史
